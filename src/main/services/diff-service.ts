...
// The status surface the dirty-set backfill reuses (LoreRepository service
// provides it). Kept a narrow structural interface so tests inject a
// lightweight fake and the backfill path never re-parses repository status
// itself.
