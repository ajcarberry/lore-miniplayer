...
// preloaded by Mission Control). Subscribes to re-targets first, then pulls the
// current request on mount, mirroring the Mission Control snapshot hook so a
// context re-delivered during the pull is not missed. Every payload is
